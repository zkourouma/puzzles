                ...
                return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(function __do() {
                    ...
                    return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Aff.attempt(v.value0.value1))(function (v1) {
                        return Data_Functor["void"](Effect_Aff.functorAff)((function () {
                            ...
                            throw new Error("Failed pattern match at Test.Unit.Output.Fancy (line 42, column 14 - line 57, column 1): " + [ v1.constructor.name ]);
                        })());
                    });
                });
            };
            throw new Error("Failed pattern match at Test.Unit.Output.Fancy (line 28, column 5 - line 34, column 5): " + [ path.constructor.name, v.constructor.name ]);
        };
    };
